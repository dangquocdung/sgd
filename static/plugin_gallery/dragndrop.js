(function() {
    ...
    function UploadFile(file) {
        ...
        if (xhr.upload) {
            ...
            // progress bar
            xhr.upload.addEventListener("progress1", function(e) {
            ...
            xhr.onreadystatechange = function(e) {
                if (xhr.readyState == 4) {
					...
					if (xhr.status == 200) {
						...
						ajax(myformdata.action.replace('upload_data1','view_gallery'),[],'progress1');
					}
                }
            };
